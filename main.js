...
let face = "the first thing a person sees"; /*Between the quotation marks, 
...
let red = "a violent but beautiful color"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "head"; //repeat the instructions for the word "brain"

let masculine = "strong"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "thoughtful"; //define 'think' in VERB form,
